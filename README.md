...
**Mercadata** es un comparador de precios en tiempo real para los principales supermercados y farmacias de Venezuela (**Central Madeirense**, **Gama Supermercados**, **Automercados Plaza's**, **Kalea Market**, **Farmatodo**, **Rio Market** y **Plan Suarez**). Permite a los usuarios encontrar rápidamente qué establecimiento ofrece el precio más bajo para cualquier producto, con precios estandarizados con **IVA incluido**, conversión automática de divisas (USD / Bs. a tasa oficial BCV) y filtros inteligentes por presentación y marca.
...
- **Comparación Multi-Tienda en Tiempo Real**: Conexión directa a las APIs y catálogos de 7 grandes cadenas de retail en Venezuela.
...
| **Plan Suarez** | OpenCart (HTML Parsing) | VES | `price-normal` (con IVA) |
